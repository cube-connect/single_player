...
public:
    ThirdPersonController(class MyObject *target, glm::vec3 front, glm::vec3 right, float radius = 0.0f,
                          float mouse_sensitivity = 0.1f, bool invert_yaw_movement = false);
...
private:
    class MyObject* m_Target;
    Transform* m_TargetTransform;
    float m_Radius;
    float m_MouseSensitivity;
    bool m_InvertYawMovement;
